...
Это вариант, который мы сегодня будем использовать. Здесь указывается ветка, на которую
будем переключаться. Об этом и поговорим сегодня. А в предыдущей версии мы вместо
